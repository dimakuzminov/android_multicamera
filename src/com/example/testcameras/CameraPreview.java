...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private PreviewCallback mPreviewCallback = new PreviewCallback() {
        public void onPreviewFrame(byte[] data, Camera arg1) {     
        	...
        	try {
        		...
        		Log.d(MainActivity.TAG, "Error in onPreviewFrame id " + mId + ", " + e.getMessage());
        	}
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        try {
            ...
            Log.d(MainActivity.TAG, "Error setting camera preview id " + mId + ", " + e.getMessage());
        }
    }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        ...
        try {
            ...
            Log.d(MainActivity.TAG, "Error starting camera preview id " + mId + ", " + e.getMessage());
        }
    }
}